...
```{r cellchat-plots, message=FALSE, warning=FALSE}
...
gg1 <- netVisual_bubble(cellchat, sources.use = 4, targets.use = c(5:11),  comparison = c(1, 2), max.dataset = 2, title.name = "Increased signaling in GAAKO", angle.x = 45, remove.isolate = T, font.size = 14)
gg2 <- netVisual_bubble(cellchat, sources.use = 4, targets.use = c(5:11),  comparison = c(1, 2), max.dataset = 1, title.name = "Decreased signaling in GAAKO", angle.x = 45, remove.isolate = T, font.size = 17)
gg1
gg2
