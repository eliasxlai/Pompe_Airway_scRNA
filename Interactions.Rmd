...
# Chord diagram
par(mfrow=c(1,1))
# netVisual_aggregate(cellchat, signaling = pathways.show, layout = "chord") # supposed to work
...
setwd(Volumes/SanDiskExtreme/Pompe_Airway_scRNA/CellChat_Plots)
...
netVisual_bubble(cellchat, sources.use = 4, targets.use = c(5:11), signaling = c("LAMININ","COLLAGEN"), remove.isolate = FALSE)
#> Comparing communications on a single object
```
