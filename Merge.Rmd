...
```{r remobe_doublets, message = FALSE, warning = FALSE}
...
# resolution 10, without 
gaa_merge_rm_clusters <- c(107, 110, 68, 120, 118, 116)
gaa_merge_withoutdoublets <- subset(x = gaa_merge, idents = gaa_merge_rm_clusters, invert = TRUE)
gaa_merge_withoutdoublets <- FindClusters(gaa_merge, resolution = 20)
# Overall UMAP
