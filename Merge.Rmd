...
DimPlot(gaa_merge, reduction = "umap", label = TRUE, pt.size = 0.001) + NoLegend()
gaa_merge_rm_clusters <- c(352, 585, 24, 184, 356, 132, 179, 301, 456, 598, 486, 320, 433, 396, 479, 267, 488, 559, 347, 108, 39, 336, 553, 141, 407, 171, 306, 124, 431)
...
# Cluster 3: Alveolar Fibroblast
FeaturePlot(merge, c("Ces1d", "Npnt", "Pdgfra"))
# Cluster #: Adventitial Fibroblast
...
adventitialfibroblast.markers <- FindMarkers(adventitialfibroblast,ident.1 = "Control",ident.2 = "GAA KO",min.pct = 0.0,logfc.threshold = 0.01)
...
alveolarfibroblast.markers <- FindMarkers(alveolarfibroblast,ident.1 = "Control",ident.2 = "GAA KO",min.pct = 0.0,logfc.threshold = 0.01)
...
capillaryendothelial.markers <- FindMarkers(capillaryendothelial,ident.1 = "Control",ident.2 = "GAA KO",min.pct = 0.0,logfc.threshold = 0.01)
...
peribronchial.markers <- FindMarkers(peribronchial,ident.1 = "Control",ident.2 = "GAA KO",min.pct = 0.0,logfc.threshold = 0.01)
...
lymphaticendothelial.markers <- FindMarkers(lymphaticendothelial,ident.1 = "Control",ident.2 = "GAA KO",min.pct = 0.0,logfc.threshold = 0.01)
...
saveRDS(fibroblast, file = "output/adventitialfibroblast")
saveRDS(fibroblast, file = "output/alveolarfibroblast")
...
EnhancedVolcano(lymphaticendothelial.markers,
                ...
                #  selectLab = m$V1,
                lab = rownames(lymphaticendothelial.markers.markers),
                x = 'avg_log2FC',
                y = 'p_val_adj',
                #ylim = c(0,10),
                #xlim = c(-1,1),
