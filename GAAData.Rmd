...
library(scales)
gaa <- readRDS("output.nosync/beforeSoupX/gaa.rds")
gaa.markers <- readRDS("output.nosync/beforeSoupX/gaamarkers.rds")
gaa_gcsubset.markers <- readRDS("output.nosync/beforeSoupX/gaa_gcsubsetmarkers.rds")
gaa_gcsubset <- readRDS("output.nosync/beforeSoupX/gaa_gcsubset.rds")
gaa_withoutdoublets <- readRDS("output.nosync/beforeSoupX/gaa_withoutdoublets.rds")
```

```{r create-object, message = FALSE, warning = FALSE}
# Load the gaa dataset
gaa.data <- Read10X(data.dir = "data.nosync/GAA_KO/outs/filtered_feature_bc_matrix/")
...
saveRDS(gaa, file = "output.nosync/beforeSoupX/gaa.rds")
```
...
saveRDS(gaa.markers, file = "output.nosync/beforeSoupX/gaamarkers.rds")
saveRDS(gaa, file = "output.nosync/beforeSoupX/gaa.rds")
```
...
saveRDS(gaa_gcsubset.markers, file = "output.nosync/beforeSoupX/gaa_gcsubsetmarkers.rds")
saveRDS(gaa_gcsubset, file = "output.nosync/beforeSoupX/gaa_gcsubset.rds")
...
saveRDS(gaa_withoutdoublets, file = "output.nosync/beforeSoupX/gaa_withoutdoublets.rds")
```
