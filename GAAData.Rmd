...
gaa_gcsubset.markers <- readRDS("output.nosync/gaa_gcsubsetmarkers.rds")
gaa_gcsubset <- readRDS("output.nosync/gaa_gcsubset.rds")
gaa_withoutdoublets <- readRDS("output.nosync/gaa_withoutdoublets.rds")
```
