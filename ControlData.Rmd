...
control_withoutdoublets <- readRDS("output.nosync/control_withoutdoublets.rds")
```
...
saveRDS(control_withoutdoublets, file = "output.nosync/control_withoutdoublets.rds")
```
