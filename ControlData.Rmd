...
library(scales)
control <- readRDS("output/beforeSoupX/control.rds")
control.markers <- readRDS("output/beforeSoupX/controlmarkers.rds")
control_gcsubset.markers <- readRDS("output/beforeSoupX/control_gcsubsetmarkers.rds")
control_gcsubset <- readRDS("output/beforeSoupX/control_gcsubset.rds")
control_withoutdoublets <- readRDS("output/beforeSoupX/control_withoutdoublets.rds")
```
...
saveRDS(control, file = "output/beforeSoupX/control.rds")
```
...
saveRDS(control_gcsubset.markers, file = "output/beforeSoupX/control_gcsubsetmarkers.rds")
saveRDS(control_gcsubset, file = "output/beforeSoupX/control_gcsubset.rds")
...
saveRDS(control_withoutdoublets, file = "output/beforeSoupX/control_withoutdoublets.rds")
```
