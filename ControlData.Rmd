...
library(scales)
control <- readRDS("output.nosync/beforeSoupX/control.rds")
control.markers <- readRDS("output.nosync/beforeSoupX/controlmarkers.rds")
control_gcsubset.markers <- readRDS("output.nosync/beforeSoupX/control_gcsubsetmarkers.rds")
control_gcsubset <- readRDS("output.nosync/beforeSoupX/control_gcsubset.rds")
control_withoutdoublets <- readRDS("output.nosync/beforeSoupX/control_withoutdoublets.rds")
```

```{r create-object, message = FALSE, warning = FALSE}
# Load the control dataset
control.data <- Read10X(data.dir = "data.nosync/Control/outs/filtered_feature_bc_matrix/")
...
saveRDS(control, file = "output.nosync/beforeSoupX/control.rds")
```
...
saveRDS(control.markers, file = "output.nosync/beforeSoupX/controlmarkers.rds")
saveRDS(control, file = "output.nosync/beforeSoupX/control.rds")
```
...
saveRDS(control_gcsubset.markers, file = "output.nosync/beforeSoupX/control_gcsubsetmarkers.rds")
saveRDS(control_gcsubset, file = "output.nosync/beforeSoupX/control_gcsubset.rds")
...
# without 94, 52, 46, 92, 83, 15, 9, 77, 82, 87, 86, 59, 90, 56, 58, 75, 74, 57, 93, 55, 98
control_rm_clusters <- c(94, 52, 46, 92, 83, 15, 9, 77, 82, 87, 86, 
                     59, 90, 56, 58, 75, 74, 57, 93, 55, 98)
control_withoutdoublets <- subset(x = control, idents = control_rm_clusters, invert = TRUE)
saveRDS(control_withoutdoublets, file = "output.nosync/beforeSoupX/control_withoutdoublets.rds")
```
